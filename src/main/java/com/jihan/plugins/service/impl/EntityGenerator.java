package com.jihan.plugins.service.impl;
...
import com.jihan.plugins.service.CodeGenerator;
import com.jihan.plugins.util.StringUtils;
...
public class EntityGenerator extends CodeGeneratorManager implements CodeGenerator {
	...
	public void genCode(String tableName, String customEntityName) {
		...
		if (StringUtils.isNullOrEmpty(customEntityName)) {
			customEntityName = StringUtils.underScoreCase2CamelCase(tableName);
		}
